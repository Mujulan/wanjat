...
⭔ Url : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
            ...
            break
            case 'anime': case 'waifu': case 'husbu': case 'shinobu': case 'megumin': case 'waifus': case 'trap': case 'blowjob': {
                m.reply(mess.wait)
...
case 'neko': {
let buttonMessage = {
image: { url: 'https://betabotz-api.herokuapp.com/api/nsfw/neko?apikey=BetaBotz' },
...
case 'nekos': {
let buttonMessage = {
image: { url: 'https://betabotz-api.herokuapp.com/api/nsfw/neko2?apikey=BetaBotz' },
caption: ` Random ${command}`,
footer: kagura.user.name,
headerType: 4
}
...
case 'hentai': {
let buttonMessage = {
image: { url: 'https://betabotz-api.herokuapp.com/api/nsfw/hentai?apikey=BetaBotz' },
caption: ` Random ${command}`,
footer: kagura.user.name,
headerType: 4
}
...
case 'hekel': {
	let buttonMessage = {
image: { url: 'https://betabotz-api.herokuapp.com/api/wallpaper/hekel?apikey=BetaBotz' },
caption: ` Random ${command}`,
footer: kagura.user.name,
headerType: 4
}
...
case 'welpeperhp': {
	let buttonMessage = {
image: { url: 'https://betabotz-api.herokuapp.com/api/wallpaper/wallhp?apikey=BetaBotz' },
caption: ` Random ${command}`,
footer: kagura.user.name,
headerType: 4
}
